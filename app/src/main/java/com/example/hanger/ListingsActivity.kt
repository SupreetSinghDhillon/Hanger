...
class ListingsActivity: AppCompatActivity(), AdapterView.OnItemSelectedListener, LocationListener {
    ...
    private lateinit var fetchedListings: ArrayList<ListingItemsModel>
...
//    private lateinit var dateOrderedListings: ArrayList<ListingItemsModel>
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        listings = ArrayList()
        fetchedListings = ArrayList()
        listingsAdapter = ListingAdapter(listings, this)
        checkPermission()
    }
...
//                println("debug: snapshot is $snapshot")
    ...
    private fun applyFilters() {
        ...
        var newListings: ArrayList<ListingItemsModel> = ArrayList()
...
//            println("debug: distance is $distance")
        ...
        if (selectedFilter == "Price: Low to High") {
            newListings.sortWith(compareBy<ListingItemsModel> {
        ...
        recyclerViewListings.adapter = listingsAdapter
        listingsAdapter.setOnItemClickListener(object : ListingAdapter.onItemClickListener {
